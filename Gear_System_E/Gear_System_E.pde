...
ArrayList<PCoupledLines> art = new ArrayList<PCoupledLines>();
...
public void addPart(int theValue){
      art.add(new PCoupledLines(selX,selY,250,200,true));
}
