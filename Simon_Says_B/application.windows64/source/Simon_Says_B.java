...
public class Simon_Says_B extends PApplet {
...
public void drawButton(int quad, boolean h) {
  noStroke();
  int o = 150;
  if (h) o = 255;
  switch(quad) {
...
//draw the scale
public void meter(int x, int y, int l, float s) {
  pushMatrix();
  translate(x, y);
  scale(s);
  fill(0, 255, 0);
...
public void mouseReleased() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--hide-stop", "Simon_Says_B" };
    if (passedArgs != null) {
