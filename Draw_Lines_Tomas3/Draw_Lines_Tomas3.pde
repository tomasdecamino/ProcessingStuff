...
void draw() {
  ...
  beginShape();
  vertex(pincel.get(0).x,pincel.get(0).y);
  bezierVertex(pincel.get(1).x+r,pincel.get(1).y+r,
               pincel.get(2).x,pincel.get(2).y+r, 
               pincel.get(3).x+r,pincel.get(3).y+r);
  bezierVertex(pincel.get(4).x,pincel.get(4).y+r,
               pincel.get(5).x+r,pincel.get(5).y+r, 
               pincel.get(6).x,pincel.get(6).y);
  endShape();
