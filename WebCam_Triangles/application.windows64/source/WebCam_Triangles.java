...
public class WebCam_Triangles extends PApplet {
...
public void draw() {
  ...
  // if (mousePressed) {
     ...
     for (int i = 0; i < 133; i++){
       for(int j = 0; j < 100; j++){
         int loc = i + (j * width) ;
         int r = PApplet.parseInt(red(pixels[loc])/255 *16);
         fill(mycolours[r]);
...
// funcion que construye un triangulo en posicion i,j
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "WebCam_Triangles" };
    if (passedArgs != null) {
